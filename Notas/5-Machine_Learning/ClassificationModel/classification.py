...
# fig.show()
fig.savefig('Notas/5-Machine_Learning/ClassificationModel/test.pdf')
plt.close(fig)
# print(tds)
# print(df_tds)
...
fig.savefig('Notas/5-Machine_Learning/ClassificationModel/trained.pdf')
plt.close(fig)
...
# fig.show()
fig.savefig('Notas/5-Machine_Learning/ClassificationModel/compare.pdf')
# print(tds)
# print(df_tds)
